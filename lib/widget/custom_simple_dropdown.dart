...
class CustomSimpleDropdown<T> extends StatefulWidget {
  final String label;
  final List<T> items;
  final T? value;
  ...
  @override
  State<CustomSimpleDropdown<T>> createState() => _CustomSimpleDropdownState<T>();
}

class _CustomSimpleDropdownState<T> extends State<CustomSimpleDropdown<T>> {
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            ...
            children: [
              Icon(Icons.av_timer_rounded, size: 16, color: _isOpen ? const Color(0xFF1CB485) : Colors.grey[600]),
